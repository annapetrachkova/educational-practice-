...
console.log(collection.getPage(10, 10))
console.log(collection.getPage(0, 4, {vendor: 'Анна Петрачкова'}))
...
console.log(collection.add({id: '21',
    ...
    validUntil: new Date('2021-07-01T24:00:00'),
    discount: '40%',
    hashTags: ['Прочие услуги']})) //объявление добавится
console.log(collection.add({id: '14',
    description: 'Суши от Rollbox',
    createdAt: new Date('2021-03-01T11:00:00'),
    link: 'https://rollbox.by/',
    vendor: 'Rollbox',
